...
%   unclustered_z2 =     seg_length x 32 matrix where the columns are the
%                        feature vectors
...
%                        'spkID_vector' will use the labels from GT to select feature vectors
%                        and then use the Bayesian Information Criterion to assign a speaker ID
%                        to the computed labels
%   lambda =             design parameter for the BIC, merges more if it is
%                        higher
